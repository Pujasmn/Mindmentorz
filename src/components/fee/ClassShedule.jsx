import { Check, ChevronDown, Cloud, List, Menu, Printer, Search, X } from 'lucide-react';
    ...
    <div className="p-6 bg-white">
      ...
      <div className="flex justify-end mb-4">
        <button 
          ...
          className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-600 hover:bg-white rounded-lg"
        >
          FILTERS
        </button>
      </div>
